...
class Mprealcarttotalshippingfee extends Module
{
    ...
    public function install()
    {
        ...
        $cartreplace = array('$orderTotalwithDiscountsNoVirtual = ($order_total - $this->getOrderTotal(true, Cart::ONLY_DISCOUNTS));'."\n".'if ($carrier->range_behavior) {','$shipping_cost += $carrier->getDeliveryPriceByPrice($orderTotalwithDiscountsNoVirtual');
    ...
    public function getContent()
    {
         ...
         */
        if (((bool)Tools::isSubmit('submitMprealcarttotalshippingfeeModule')) == true) {
            $this->postProcess();
        }
